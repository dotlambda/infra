...
#### Emacs overlay
  ...
  [https://hydra.nix-community.org/project/emacs-overlay](https://hydra.nix-community.org/project/emacs-overlay)

#### CUDA and ROCm

  [package set in Nixpkgs](https://github.com/NixOS/nixpkgs/blob/master/pkgs/top-level/release-cuda.nix)
